...
function setup() {
  ...
  World.add(engine.world, [ground, box, circle, polygon, polygon2, trapezoid, polygon1A, polygon1B, constraint1, constraint2, constraint3,constraint4,constraint5, constraint6]);

  // BODIES FOR CONSTRAINT
